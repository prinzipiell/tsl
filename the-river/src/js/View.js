...
import River from './tsl/River.js';
	...
	initView() {
		...
		.load( [ 'px.png', 'nx.png', 'py.png', 'ny.png', 'pz.png', 'nz.png' ], () => {
			...
			.load( ['./textures/stone-bw.png'], () => {
				...
				.load( ['./textures/stone-bw.png'], () => {    // you might use ./textures/stone.jpg instead
